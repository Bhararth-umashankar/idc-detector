...
(async function () {
	...
	breast_cancer_model = await tf.loadModel('http://localhost:81/idc_model_v1/model.json');
	$("#selected-image").attr("src", "http://localhost:81/normal.png");
})();
...
(async function () {
	...
	met_cancer_model = await tf.loadModel('http://localhost:81/idc_model_v1/model.json');
	$("#selected-image").attr("src", "http://localhost:81/idc_model_v1/normal.png");
